...
public class SantaConclusionScreen extends JamScreen {
    private Stage stage;
    ...
    public void show() {
        ...
        spineDrawable.getAnimationState().setAnimation(0, animationSaySfxConclusion, false);
        
        spineDrawable.getAnimationState().addListener(new AnimationState.AnimationStateAdapter() {
            @Override
            public void complete(AnimationState.TrackEntry entry) {
                if (entry.getAnimation() == animationSaySfxConclusion) {
