...
import static com.ray3k.template.Resources.SpineGameOverShoot.*;
import static com.ray3k.template.Resources.*;

public class GameOver3Screen extends JamScreen {
    private Stage stage;
    ...
    public void show() {
        ...
        var label = new Label("Click to set your friend free", skin);
        table.add(label);
        ...
        spineDrawable.getAnimationState().addListener(new AnimationState.AnimationStateAdapter() {
            ...
            public void complete(AnimationState.TrackEntry entry) {
                if (entry.getAnimation() == animationSlump) {
        ...
        stage.addListener(new InputListener() {
            ...
            public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
                ...
                if (state.getCurrent(0).getAnimation() != animationSlump) {
                    state.setAnimation(0, animationSlump, false);
