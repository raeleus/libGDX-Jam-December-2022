...
import static com.ray3k.template.Resources.SpineGameOverTooth.*;
import static com.ray3k.template.Resources.*;

public class GameOver5Screen extends JamScreen {
    private Stage stage;
    ...
    public void show() {
        ...
        label = new Label("Click to relieve pressure", skin);
        table.add(label);
        ...
        stage.addListener(new InputListener() {
            ...
            public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
                ...
                if (state.getCurrent(0).getAnimation() == animationStand) {
                    ...
                    label.setText("This is for your own good. Do it faster.");
                    pain += .10f;
                }
