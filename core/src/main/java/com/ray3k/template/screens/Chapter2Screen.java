...
public class Chapter2Screen extends JamScreen {
    private Stage stage;
    ...
    public void show() {
        ...
        var label = new Label("Chapter 2: Why didn't you do the dishes like I told you?", skin);
...
//                    core.transition(new LogoScreen());
        ...
        stage.addListener(new InputListener() {
            ...
            public boolean keyDown(InputEvent event, int keycode) {
                core.transition(new Santa2Screen());
                return true;
            }
