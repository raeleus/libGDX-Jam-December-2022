...
public class Santa1Screen extends JamScreen {
    private Stage stage;
    ...
    public void show() {
        ...
        spineDrawable.getAnimationState().setAnimation(0, animationSaySfxChapter1, false);
        
        spineDrawable.getAnimationState().addListener(new AnimationState.AnimationStateAdapter() {
            @Override
            public void complete(AnimationState.TrackEntry entry) {
                if (entry.getAnimation() == animationSaySfxChapter1) {
                    core.transition(new Chapter2Screen());
                }
            }
